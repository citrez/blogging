...
I then save all the songs locally, so i don't need to re download them every time
...
album_vector <- map2(
  ...
  .y = c(11, 8, 22, 19, 20, 7, 23, 23, 9, 22, 7, 19, 11, 22, 13, 19, 13, 20, 16),
  ~ rep(.x, .y)
) %>% unlist()

df <- df %>% 
  mutate(album = album_vector)
